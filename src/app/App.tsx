...
export default function App() {
  ...
  // DOWNLOAD CSV FROM DEPLOYED BACKEND
  const downloadCSV = () => {
    window.open(
      "https://margdarshak-3.onrender.com/api/download-traffic-csv",
      "_blank"
    );
  };
  ...
  return (
    <div className="relative min-h-screen bg-[#0B0F1A] dark">
      ...
      {/* MAIN CONTENT */}
      <div
        className={`min-h-screen bg-gradient-to-br from-[#0B0F1A] via-[#0D1321] to-[#0B0F1A] p-8 transition-all duration-500 ${
          !currentUser
        ...
        <div className="max-w-[2000px] mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-white text-4xl mb-2">
              Smart Parking & Micro Route Optimizer
            </h1>
            <p className="text-gray-400 text-lg">
              Complete UI Design System for Urban Logistics
            </p>
          </div>
